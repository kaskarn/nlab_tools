...
# dir_keep_list = "/proj/epi/CVDGeneNas/sol/taor/mega_imputed/dosage_files/vcf_variant_list_info0.4/list"
dir_keep_list = "/proj/epi/Genetic_Data_Center/calico/PAGEII_genotypes/MEGA/imputed_data/MEGA_info_split/MEGA."
...
for file_input in files_input:
  ...
  if flag_wald:
    file_keep_list = file_keep_list.rstrip(".wald.out")   
  else:
    file_keep_list = file_keep_list.rstrip(".score.snp.out")
  file_keep_list = file_keep_list+".list"
